...
@section('meta')
  <meta name="description" content="{{ $pref->pref_name }}の出前・デリバリー・宅配を一括検索するならいえメシへ。全国7サイト39,907店舗のデリバリーを無料で簡単に比較・検索できます。取扱サービスは、Uber Eats, 出前館, ｄデリバリー, 楽天デリバリー, menu, Wolt, foodpanda。">
  ...
  <meta property="og:description" content="{{ $pref->pref_name }}の出前・デリバリー・宅配を一括検索するならいえメシへ。全国7サイト39,907店舗のデリバリーを無料で簡単に比較・検索できます。取扱サービスは、Uber Eats, 出前館, ｄデリバリー, 楽天デリバリー, menu, Wolt, foodpanda。">
  ...
  <meta name="twitter:description" content="{{ $pref->pref_name }}の出前・デリバリー・宅配を一括検索するならいえメシへ。全国7サイト39,907店舗のデリバリーを無料で簡単に比較・検索できます。取扱サービスは、Uber Eats, 出前館, ｄデリバリー, 楽天デリバリー, menu, Wolt, foodpanda。">
