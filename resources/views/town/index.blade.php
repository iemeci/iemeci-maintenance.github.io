...
@section('title')
  <title>{{ $city->city_name }}の出前・デリバリー・宅配を一括比較 - {{ config('app.name') }}</title>
@endsection
...
@section('meta')
  ...
  <meta property="og:title" content="{{ $city->city_name }}の出前・デリバリー・宅配を一括比較 - {{ config('app.name') }}">
  ...
  <meta name="twitter:title" content="{{ $city->city_name }}の出前・デリバリー・宅配を一括比較">
