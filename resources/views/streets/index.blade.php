...
@section('meta')
  ...
  <meta property="og:description" content="{{ $town->city_name }}{{ $town->city_name === $town->town_name ? '' : $town->town_name }}の出前・デリバリー・宅配を一括検索するならいえメシへ。主要宅配サービスの美味しい飲食店を簡単に比較・検索できます。宅配サイトで直接予約できるため手数料無料です。取扱サービスは、Uber Eats（ウーバーイーツ）,ｄデリバリー,楽天デリバリー。">
  ...
  <meta name="twitter:description" content="{{ $town->city_name }}{{ $town->city_name === $town->town_name ? '' : $town->town_name }}の出前・デリバリー・宅配を一括検索するならいえメシへ。主要宅配サービスの美味しい飲食店を簡単に比較・検索できます。宅配サイトで直接予約できるため手数料無料です。取扱サービスは、Uber Eats（ウーバーイーツ）,ｄデリバリー,楽天デリバリー。">
